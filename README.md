...
**Estatística Computacional Com R** ministrada pelo **Prof. Deivison
Venicio Souza** (Laboratório de Manejo Florestal, Tecnologias e
Comunidades Amazônicas) no **Programa de Pós-Graduação em Biodiversidade
e Conservação (PPGBC)/UFPA** e **Programa de Pós-Graduação em Ciência,
...
| Slide | Link |
|:---|:---|
| R/01-Introducao-R.R | <https://deivisonsouza.github.io/Estatistica-Computacional-Com-R/R/01-Introducao-R.R> |
| R/02-Importacao-Manipulacao-Dados.R | <https://deivisonsouza.github.io/Estatistica-Computacional-Com-R/R/02-Importacao-Manipulacao-Dados.R> |
