...
background-image: url(fig/capa.png)
background-position: center
background-size: cover
background-repeat: no-repeat

<img src="fig/ufpa.png" style="position:absolute; top:25px; left:25px; width:150px; z-index:10;">
<img src="fig/LMFTCA.png" style="position:absolute; top:25px; right:25px; width:150px; z-index:10;">
<img src="fig/PPGCTIF.png" style="position:absolute; bottom:25px; left:25px; width:150px; z-index:10;">
<img src="fig/PPGBC.png" style="position:absolute; bottom:25px; right:25px; width:180px; z-index:10;">
...
Criar seu primeiro Projeto no RStudio e começar a explorar a linguagem R.
