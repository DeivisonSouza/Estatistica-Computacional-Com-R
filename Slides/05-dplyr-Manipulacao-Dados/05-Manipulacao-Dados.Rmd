...
subtitle: "Manipulação de Dados no R (dplyr)"
...
## ᨒ <br> `r anicon::faa("pagelines", animate="horizontal", colour="green")` .font80[Manipulação de Dados no R]`r anicon::faa("pagelines", animate="horizontal", colour="green")`
###### (Pacote: dplyr)
...
Esta aula (.blue[**Manipulação de Dados**]) constitui a segunda parte do **Módulo 2**, dedicado ao estudo de alguns dos principais pacotes do ecossistema **Tidyverse**. 
...
```{r echo=FALSE, out.width='15%', fig.align='center', fig.cap='', dpi=600}
knitr::include_graphics("https://dplyr.tidyverse.org/logo.png")
```
...
.font110[
.alert2[
🎯 **Foco da aula**: **Organizar e Transformar Dados**
...
**A base completa pode ser acessada em**: [IF100%](https://deivisonsouza.github.io/FL03034-EF/Slides/data/IF100.xlsx)
]
]
]
...
.center[Selecionar variáveis (colunas)]
