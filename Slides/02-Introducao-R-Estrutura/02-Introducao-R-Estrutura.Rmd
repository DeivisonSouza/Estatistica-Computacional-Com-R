...
### Matrizes - .black[Imagens digitais (escala de cinza)]

.pull-left[

```{r echo=FALSE, out.width='70%'}
knitr::include_graphics("fig/leaf_1024x1024.png")
```
...
knitr::include_graphics("fig/leaf_50x50.png")
```

.center[
Imagem reduzida (50 × 50 pixels)
]
...
.alert[
💡 Em escala de cinza, cada pixel é armazenado em uma matriz.
]
...
mat <- readPNG("fig/leaf_50x50.png")
