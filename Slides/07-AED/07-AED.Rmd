...
.font90[
.alert2[
💡 A função `plot_missing()` resume visualmente a quantidade e a proporção de valores ausentes em cada variável do conjunto de dados.
]
]
...
```{r ref.label="plot_missing", echo=FALSE, eval=TRUE, fig.align='center', out.width='100%'}
data2 <-
  data |>
  mutate(
    Sepal_Length = replace(Sepal_Length, c(5, 18, 42), NA),
