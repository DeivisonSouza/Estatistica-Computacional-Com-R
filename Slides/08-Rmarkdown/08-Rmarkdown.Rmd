...
.pull-left-4[
.font95[
- Utilize .red[`*texto*`] para escrever em *itálico*.
- Utilize .red[`**texto**`] para escrever em **negrito**.
- Utilize .red[`***texto***`] para escrever em ***negrito e itálico***.
]

<br>

.alert[
💡 Prefira utilizar **asteriscos** para manter a sintaxe mais simples e consistente.
]
...
.pull-left-4[
.font95[
- Utilize .red[`~texto~`] para escrever em **subscrito**.
- Utilize .red[`^texto^`] para escrever em **sobrescrito**.
]

<br>

.alert[
💡 Muito utilizado para representar **fórmulas químicas** e **expressões matemáticas**.
]
...
- Recomenda-se iniciar a lista pelo número **1**.
- O Markdown pode numerar os itens automaticamente.
]

<br>

.alert[
💡 Escrever todos os itens iniciando por .red[`1.`] permite que o Markdown numere a lista automaticamente.
]
...
| **Markdown** | **Saída Renderizada** |
|:------------:|:---------------------:|
| `1. Primeiro item`<br>`1. Segundo item`<br>`1. Terceiro item` | 1. Primeiro item<br>2. Segundo item<br>3. Terceiro item |
]
]
]
...
.pull-left-4[
.font95[
- Utilize o símbolo .red[`-`] antes de cada item.
- Cada item da lista deve iniciar em uma nova linha.
]

<br>

.alert[
💡 Utilize sempre o símbolo .red[`-`] para manter um padrão de escrita.
]
...
| **Markdown** | **Saída Renderizada** |
|:------------:|:---------------------:|
| `- Primeiro item`<br>`- Segundo item`<br>`- Terceiro item` | • Primeiro item<br>• Segundo item<br>• Terceiro item |
]
]
]
...
.pull-left-4[
.font95[
- Utilize **recuo** para criar uma sublista.
- Cada nível de recuo cria uma nova lista hierárquica.
]

<br>

.alert[
💡 Utilize **quatro espaços** (ou uma tabulação) antes do item para criar uma sublista.
]
...
| **Markdown** | **Saída Renderizada** |
|:------------:|:---------------------:|
| `1. Primeiro item`<br>`2. Segundo item`<br>`3. Terceiro item`<br>&nbsp;&nbsp;&nbsp;&nbsp;`1. Item recuado`<br>&nbsp;&nbsp;&nbsp;&nbsp;`2. Item recuado` | 1. Primeiro item<br>2. Segundo item<br>3. Terceiro item<br>&nbsp;&nbsp;&nbsp;&nbsp;1. Item recuado<br>&nbsp;&nbsp;&nbsp;&nbsp;2. Item recuado |
]
]
]
...
.pull-left-4[
.font95[
- Utilize a sintaxe <span class="red"><code>&#91;Texto&#93;&#40;URL&#41;</code></span> para inserir um link.
- O texto será exibido como um **hiperlink** para o endereço informado.
]

<br>

.alert[
💡 Prefira utilizar um **texto descritivo** em vez de exibir a URL completa.
]
...
| **Markdown** | **Saída Renderizada** |
|:------------:|:---------------------:|
| `[Análises Ecológicas no R](https://analises-ecologicas.com/)` | [Análises Ecológicas no R](https://analises-ecologicas.com/) |
]
]
]
...
### 10. Inserção de imagens

.pull-left-4[
.font95[
- Utilize a sintaxe <span class="red"><code>&#33;&#91;Texto alternativo&#93;&#40;arquivo&#41;</code></span> para inserir uma imagem.
- Prefira utilizar **caminhos relativos** para arquivos do projeto.
]

<br>

.alert[
💡 O texto alternativo é exibido quando a imagem não pode ser carregada e melhora a acessibilidade do documento.
]
...
knitr::include_graphics("fig/girassol.jpg")
```
]
]
]
...
.pull-left-10[
.font95[
- Utilize a barra vertical .red[`|`] para separar as colunas.
- Utilize três ou mais hífens .red[`---`] para definir o cabeçalho.
- Utilize dois pontos .red[`:`] para alinhar o conteúdo das colunas.
]
...
.alert[
💡 Para tabelas maiores, utilize um gerador de tabelas em Markdown.
]
...
.pull-left-4[
.font95[
- Emojis podem ser inseridos diretamente no texto por **cópia e cola**.
- Alguns renderizadores também aceitam **códigos de emoji**.
]

<br>

.alert[
💡 Em documentos científicos, utilize emojis com moderação. Eles são mais indicados para apresentações e materiais didáticos.
]
...
---
name: resumo_markdown
## Markdown: Resumo da Sintaxe
...
|:-----------|:------------|
| Link | `[Texto](destino)` |
| Imagem | `![Texto](arquivo)` |
| Tabela | <code>&#124; Coluna &#124; Valor &#124;</code> |
]

.alert[
💡 O próximo passo é integrar Markdown e código R com R Markdown.
]
