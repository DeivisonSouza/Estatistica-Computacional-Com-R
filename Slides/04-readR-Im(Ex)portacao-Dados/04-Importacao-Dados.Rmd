...
subtitle: "Importação e Exportação de Dados no R"
...
## ᨒ <br> `r anicon::faa("pagelines", animate="horizontal", colour="green")` .font70[Importação e Exportação de Dados no R]`r anicon::faa("pagelines", animate="horizontal", colour="green")`
...
&bull;
<div4>Im(Ex)portação de Dados no R: readr, readxl e writexl</div4>
</span>
</div>
...
.font110[
.alert2[
🎯 **Foco da aula**: **Exportar e Importar Dados**
...
.center[
.font65[
**Fonte**: Gerada com ChatGPT (OpenAI, modelo GPT-5.5, 2026).
]
]
...
WICKHAM, Hadley; ÇETINKAYA-RUNDEL, Mine; GROLEMUND, Garrett. R for Data Science: Import, Tidy, Transform, Visualize, and Model Data. 2. ed. Sebastopol: O'Reilly Media, 2023. ([eBook Inglês](https://www.oreilly.com/library/view/r-for-data/9781492097396/introduction01.html?utm_source=chatgpt.com)) - ([eBook Português](https://pt.r4ds.hadley.nz/)).
