...
<img src="fig/rmarkdown.png" width="110">
&nbsp;&nbsp;&nbsp;
<img src="fig/knitr.png" width="110">
&nbsp;&nbsp;&nbsp;
...
## Cronograma .black[.font70[(**Horário: 14h00min - 18h00min**)]]

```{r, echo = FALSE, out.width='80%', fig.align='center', fig.cap='', dpi=600}
knitr::include_graphics("fig/Junho.png")
```
...
```{r, echo = FALSE, out.width='80%', fig.align='center', fig.cap='', dpi=600}
knitr::include_graphics("fig/Julho.png")
```
...
[Plano de Ensino - Estatística Computacional com R](https://raw.githubusercontent.com/DeivisonSouza/Estatistica-Computacional-Com-R/master/Slides/fig/PE.pdf)
